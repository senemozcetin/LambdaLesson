...
*/
    ...
    public static void printElFunctional(List<Integer> sayi) {
        sayi.
                stream().
                forEach((t) -> System.out.print(t + " "));// lambda expression(lambda ifadesi)
    }

    public static void printElFunctional1(List<Integer> sayi) {
        sayi.
                stream().
                forEach(System.out::print);// method referance / ::print aralarda bosluk olmadan yazdiriyor
    ...
    public static void printCiftElFunctional(List<Integer> sayi) {
        sayi.
                stream().
                filter(t -> t % 2 == 0).
                forEach(Lambda01::yazdir);// stream bize methodlarin kapisini aciyor
        // filter i if gibi dusunebiliriz
        // filtreledigim listi yazdirmak icin de forEach
    }
    ...
    //TASK :functional Programming ile list elemanlarinin 34 den
    // kucuk cift olanlarini ayni satirda aralarina bosluk birakarak print ediniz.
    ...
    //Task : functional Programming ile list elemanlarinin 34 den buyuk veya cift
    // olanlarini ayni satirda aralarina bosluk birakarak print ediniz.
